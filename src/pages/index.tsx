  ...
  return (
    <div className={"relative flex flex-row min-h-screen overflow-hidden"}>
      ...
      <div className={"relative flex flex-col flex-grow min-h-fit justify-center"}>
        ...
        <a href="https://www.linkedin.com/in/rnguyen2/" target="_blank" className={"group flex flex-row justify-center bg-gray-100/10 sm:mx-auto sm:max-w-fit md:min-h-fit sm:rounded-lg ring-1 ring-gray-300/10 shadow-lg shadow-white/20 p-5 pb-7 hover:bg-gray-100/5 hover:ring-gray-300/5 mt-5"}>
